...
.resend_form form .field {
    /* display: flex; */
    align-items: center;
    margin: 0 0 10px;
}

.resend_form form .field label.label_field {
    margin: 0;
    width: 115px;
    line-height: 45px;
    /* text-align: right; */
...
.resend_form form .field input:hover,
.resend_form form .field input:focus {
    border-bottom: solid #ff5722 2px;
    box-shadow: none;
}

.resend_form .field label.form-check-label .form-check-input {
    width: auto;
}
...
.resend_form .field label.form-check-label {
    margin-left: 20px;
    position: relative;
    top: 0;
}
.resend_form .field .resen{
    margin-top: 15px;
...
.error_404 {
    background: url('img/pattern_h.png');
    background-size: cover;
    background-color: #fff;
}
